...
namespace WinLossCounter
{
    public partial class Form1 : Form
    {
        ...
        public void Form1_Load(object sender, EventArgs e)
        {
            ...
            winpoints = new Point[]{ new Point { X = Convert.ToInt32(screenwidth * 0.12891), Y = Convert.ToInt32(screenheight * 0.26389) }, new Point { X = Convert.ToInt32(screenwidth * 0.16797), Y = Convert.ToInt32(screenheight * 0.26389) }, new Point { X = Convert.ToInt32(screenwidth * 0.20117), Y = Convert.ToInt32(screenheight * 0.26389) }, new Point { X = Convert.ToInt32(screenwidth * 0.21875), Y = Convert.ToInt32(screenheight * 0.26389) } };
            losspoints = new Point[] { new Point { X = Convert.ToInt32(screenwidth * 0.12109), Y = Convert.ToInt32(screenheight * 0.26389) }, new Point { X = Convert.ToInt32(screenwidth * 0.16210), Y = Convert.ToInt32(screenheight * 0.26389) }, new Point { X = Convert.ToInt32(screenwidth * 0.18750), Y = Convert.ToInt32(screenheight * 0.26389) }, new Point { X = Convert.ToInt32(screenwidth * 0.22266), Y = Convert.ToInt32(screenheight * 0.26389) } };
            table = ReadXML();
            DataColumnCollection columns = table.Columns;
            if (columns.Count < 1)
            {
